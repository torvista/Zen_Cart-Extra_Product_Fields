...
<ul id="productDetailsList">
    ...
    <?= (!empty($product_info->fields['products_gtin']) ? '<li>' . TEXT_GTIN . ': ' . $product_info->fields['products_gtin'] . '</li>'  : '') . "\n" ?>
    <?= (!empty($product_info->fields['products_google_product_category']) ? '<li>' . TEXT_GOOGLE_PRODUCT_CATEGORY . ': ' . $product_info->fields['products_google_product_category'] . '</li>'  : '') . "\n" ?>
</ul>
<?php
}
